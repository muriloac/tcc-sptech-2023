...
def checkpoint(model, best_loss, epoch, LR, save_path='results', filename_prefix='model'):
    """
    ...
    :type LR: float
    :param save_path: O diretório onde o checkpoint será salvo. O padrão é 'results'.
...
def train_model(
    ...
    :param save_path: Diretório para salvar checkpoints e logs. Padrão é 'results'.
    :type save_path: str, opcional
